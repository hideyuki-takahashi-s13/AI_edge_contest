...
labels = [
    ...
    Label(  'ground'               ,  14 ,       14 , 'flat'            , 1       , False        , False         , (136, 45, 66) ),
    Label(  'lane'                 ,  13 ,        13 , 'flat'            , 1       , False        , False        , ( 69, 47,142) ),
    Label(  'sidewalk'             ,  15 ,        15 , 'flat'            , 1       , False        , False        , (  0, 255,255) ),
    Label(  'parking'              ,  -1 ,      255 , 'flat'            , 1       , False        , True         , (250,170,160) ),
    Label(  'roadshoulder'         , 16 ,      16 , 'flat'            , 1       , False        , False         , (215,  0,255) ),
    Label(  'building'             , 10 ,        10 , 'construction'   , 2       , False        , False        , (  0, 203,151) ),
    Label(  'wall'                 , 12 ,        12 , 'construction'    , 2       , False        , False        , ( 92,136,125) ),
    Label(  'fence'                , -1 ,     255 , 'construction'    , 2       , False        , True        , (190,153,153) ),
    ...
    Label(  'obstacle'             , 17 ,        17 , 'object'          , 3       , False        , False        , (180,131,135) ),
    Label(  'others'               , 18 ,        18 , 'object'          , 3       , False        , False         , ( 81, 99,  0) ),
    Label(  'signal'                , 7 ,        7 , 'object'          , 3       , False        , False        , (255,255,  0) ),
    Label(  'signs'                , 8 ,        8 , 'object'          , 3       , False        , False        , (255,134,  0) ),
    Label(  'natural'              , 11 ,        11 , 'nature'          , 4       , False        , False        , ( 85,255, 50) ),
    Label(  'terrain'              , -1 ,      255 , 'nature'          , 4       , False        , True        , (152,251,152) ),
    Label(  'sky'                  , 9 ,       9 , 'sky'             , 5       , False        , False        , (  0,152,225) ),
    Label(  'pedestrian'           , 4 ,       4  , 'human'           , 6       , True         , False        , (255,  0,  0) ),
    Label(  'rider'                , -1 ,      255 , 'human'           , 6       , True         , True        , (255,  0,  0) ),
    Label(  'car'                  , 0 ,       0 , 'vehicle'         , 7       , True         , False        , (  0,  0,255) ),
    Label(  'truck'                , 2 ,       2 , 'vehicle'         , 7       , True         , False        , (180,  0,129) ),
    Label(  'bus'                  , 1 ,       1 , 'vehicle'         , 7       , True         , False        , (193,214,  0) ),
    Label(  'svehicle'              , 3 ,       3 , 'vehicle'         , 7       , True         , False         , (255,121,166) ),
    Label(  'own'                  , 19 ,      19 , 'vehicle'         , 7       , True         , False         , ( 86, 62, 67) ),
    Label(  'train'                , -1 ,      255 , 'vehicle'         , 7       , True         , True        , (  0, 80,100) ),
    Label(  'motorbike'           , 5 ,        5 , 'vehicle'         , 7       , True         , False        , ( 65,166,  1) ),
    Label(  'bicycle'              , 6 ,        6 , 'vehicle'         , 7       , True         , False        , (208,149,  1) ),
